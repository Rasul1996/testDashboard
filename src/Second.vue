      ...
      items: [
        {
          ...
          value: 23179,
          percent: (23179 / 85_000) * 100,
        },
        {
          id: 2,
          key: this.$i18n.t("bukhara"),
          value: 27362,
          percent: (27362 / 85_000) * 100,
        },
        {
          id: 3,
          key: this.$i18n.t("jizzakh"),
          value: 15559,
          percent: (15559 / 85_000) * 100,
        },
        {
          id: 4,
          key: this.$i18n.t("kashkadarya"),
          value: 23530,
          percent: (23530 / 85_000) * 100,
        },
        {
          id: 5,
          key: this.$i18n.t("navoiy"),
          value: 11943,
          percent: (11943 / 85_000) * 100,
        },
        {
          id: 6,
          key: this.$i18n.t("namangan"),
          value: 23401,
          percent: (23401 / 85_000) * 100,
        },
        {
          id: 7,
          key: this.$i18n.t("samarkand"),
          value: 44470,
          percent: (44470 / 85_000) * 100,
        },
        {
          id: 8,
          key: this.$i18n.t("surkhandarya"),
          value: 10230,
          percent: (10230 / 85_000) * 100,
        },
        {
          id: 9,
          key: this.$i18n.t("sirdarya"),
          value: 5098,
          percent: (5098 / 85_000) * 100,
        },
        {
          id: 10,
          key: this.$i18n.t("tashkent"),
          value: 62570,
          percent: (62570 / 85_000) * 100,
          hidden: true,
        },
        {
          id: 11,
